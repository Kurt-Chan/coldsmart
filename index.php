      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          while ($device = mysqli_fetch_assoc($device_query)) {
            ...
            $last_command = "OFF";
            if (mysqli_num_rows($last_command_query) > 0) {
          ...
          <div class="card ">
            ...
            <div class="card-body cardBody">
              <table id="table1" class="table table-bordered table-striped cardBody">
                ...
                <tfoot>
                  <tr class="lightText" style="background-color: #035d94;">
                    <th>Today's Total</th>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header" style="background-color: #023859;">
              ...
              <h4 class="font-weight-bold text-center lightText ">WEEKLY CONSUMPTION</h4>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header" style="background-color: #023859;">
              ...
              <h4 class="font-weight-bold text-center lightText ">MONTHLY CONSUMPTION</h4>
