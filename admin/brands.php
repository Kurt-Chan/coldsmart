                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $cnt = 1;
                                        $types_query = mysqli_query($conn, "SELECT b.id, b.name, t.name as type  from brand as b inner join device_type as t on t.id = b.device_type ");
                    ...
                    <form action="functions/add_brand.php" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" name="name" id="name" class="form-control" placeholder="ex: Panasonic">
                            </div>
                        </div>
